...
// получая event.target.dataset.id
// 2. Затем нужно удалить ElemBasket, используя поиск по тому же id 

// Для добавления товара:
// 1. Почти так же, как и у удаления товара, при нажатии на кнопку купить 
// добавлять товар в массив товаров
// 2. Создавать с помощью ElemBasket новый объект и через метод render 
// добавляем его в div.basket