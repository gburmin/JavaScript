let mover = {
    ...
    getNextPosition(direction) {
        ...
        switch (direction) {
            case 1:
                if (nextPosition.x-1 >= 0 &&  nextPosition.y+1 < config.colsCount) {
                    nextPosition.x--;
                    nextPosition.y++;
                    break;
                } 
                break;
            case 2:
                if (nextPosition.y+1 < config.colsCount) {
                nextPosition.y++;
                break; }
                break;
                case 3:
                    if (nextPosition.x+1 < config.rowsCount && nextPosition.y+1 < config.colsCount) {
                        nextPosition.x++;
                        nextPosition.y++;
                        break;
                    } 
            ...
            case 4:
                ...
                break;
            case 6:
                if (nextPosition.x+1 < config.rowsCount) {
                nextPosition.x++;
                break;
            }
            break;
            ...
            case 8:
                ...
                break;
                case 9:
                    if (nextPosition.x+1 < config.rowsCount && nextPosition.y-1 >= 0) {
                        nextPosition.x++;
                        nextPosition.y--;
                        break;
                    } 
